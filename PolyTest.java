...
public class PolyTest{
    ...
    /**
     * Tests polynomial division for polynomials with remainders. 
     * Assumes the following methods are correct: constructor, equals(), add(), multiply().
     */
    @Test
    public void test6DivRemainder() {
       // Division with remainders
       Poly p1 = new Poly(3,3); 
       p1 = p1.add(new Poly(1, 1));
       Poly p2 = new Poly(1, 2);
       Poly p3 = p1.divide(p2); 
       assertEquals("3x^3 + x / x^2 != null", p3, null);
       
       p2 = p2.add(new Poly(5, 0));
       Poly p4 = p1.divide(p2);
       assertEquals("3x^3 + x / x^2 + 5 != null", p4, null);
       
       Poly p5 = new Poly(1, 1);
       Poly p6 = new Poly(1, 5);
       Poly p7 = p5.divide(p6);
       assertEquals("x / x^5  != null", p7, null);
    }
     ...
     */
    @Test
    public void test7Negative() {
       Poly p = new Poly(-3, 3);
       p = p.add(new Poly(-2, 2));
       ...
       Poly p6 = new Poly(-1, 0);
       Poly p3 = p2.subtract(p1);
       Poly p4 = p1.multiply(p6);
       Poly p5 = p1.divide(p6);
       assertEquals("-3x^2 - 2x^2 - x != -3x^2 - 2x^2 - x", p3, p4);
       assertEquals("-3x^2 - 2x^2 - x != -3x^2 - 2x^2 - x", p4, p5);
       assertEquals("-3x^2 - 2x^2 - x != -3x^2 - 2x^2 - x", p3, p5);
       assertEquals("-3x^2 - 2x^2 - x != -3x^2 - 2x^2 - x", p3, p);
       assertEquals("-3x^2 - 2x^2 - x != -3x^2 - 2x^2 - x", p4, p);
       assertEquals("-3x^2 - 2x^2 - x != -3x^2 - 2x^2 - x", p5, p);
       
    }
    
    /**
     * Tests polynomial subtraction for polynomials with negative coefficients. 
     * Assumes the following methods are correct: constructor, equals(), add(), multiply().
     */
    @Test
    public void test8SubtractNeg() {
       // Division with remainders
       Poly p1 = new Poly(3,3); 
       p1 = p1.subtract(new Poly(-1, 3));
       Poly p2 = new Poly(4, 3);
       assertEquals("3x^3 - -x^3 != 4x^3", p1, p2);
       
       Poly p3 = new Poly(-3,3); 
       p3 = p3.subtract(new Poly(-1, 3));
       Poly p4 = new Poly(-2, 3);
       assertEquals("-3x^3 - -x^3 != 2x^3", p3, p4);
       
    }
    
    /**
     * Tests polynomial operations with polynomials equal to 0. 
     * Assumes the following methods are correct: constructor, equals(), add(), multiply().
     */
    @Test
    public void test9Zeroes() {
       // Division with remainders
       Poly p = new Poly(0, 0);
       Poly p1 = new Poly(0,3); 
       assertEquals("0x^2 != 0", p, p1);
       
       Poly p2 = new Poly(3,3); 
       p2 = p2.add(new Poly(1, 1));
       p2 = p2.add(new Poly(2, 2));
       p2 = p2.multiply(p1);
       assertEquals("0 != 0", p, p2);
       
       Poly p3 = new Poly(3,3); 
       p3 = p3.add(new Poly(1, 1));
       Poly p4 = p3.subtract(p3);
       assertEquals("0 != 0", p, p4);
    }
     ...
     */
    @Test
    public void test10NonWhole() {
       // Operations with coefficients that are not whole coefficients
       Poly p = new Poly(4, 0);
       Poly p1 = new Poly(1,0); 
       p1 = p1.divide(p);
       Poly p2 = new Poly(.25, 0);
       assertEquals("1/4 != .25", p2, p1);
       
       p = p.add(new Poly(1, 2));
       p = p.divide(new Poly(16, 0));
       Poly p3 = new Poly(.0625, 2);
       p3 = p3.add(new Poly(.25, 0));
       assertEquals("x^2 + 4 / 16 != .0625x^2 + .25", p, p3);
       
       Poly p4 = new Poly(4, 9);
       Poly p5 = new Poly(.25, 9);
       Poly p6 = new Poly(16, 0);
       p4 = p4.divide(p5);
       assertEquals("4x^9 / .25x^9 != 16x", p4, p6);
    }
